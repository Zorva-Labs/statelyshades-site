...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; color: #14110D; max-width: 600px; line-height: 1.55;">
  <h2 style="font-family: 'Cormorant Garamond', Georgia, serif; font-weight: 400; font-size: 26px; margin: 0 0 20px;">New consultation request</h2>
  ...
  <p style="margin: 32px 0 0; font-size: 12px; color: #8B7F6F;">Sent from the Stately Shades website contact form.</p>
</div>`;
